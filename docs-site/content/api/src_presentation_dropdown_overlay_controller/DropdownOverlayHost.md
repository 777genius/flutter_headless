---
title: "DropdownOverlayHost"
description: "API documentation for DropdownOverlayHost class from dropdown_overlay_controller"
category: "Classes"
library: "dropdown_overlay_controller"
outline: [2, 3]
---

# DropdownOverlayHost <span class="docs-badge docs-badge-info">abstract</span> <span class="docs-badge docs-badge-info">interface</span>

<div class="member-signature"><div class="member-signature-code"><span class="kw">abstract</span> <span class="kw">interface</span> <span class="kw">class</span> <span class="fn">DropdownOverlayHost</span></div></div>

Callback interface for overlay controller to communicate with State.

:::info Implementers
- [RDropdownButtonHost\<T\>](/api/src_presentation_r_dropdown_button_host/RDropdownButtonHost)
:::
...
that affects [operator ==](/api/src_presentation_dropdown_overlay_controller/DropdownOverlayHost#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_presentation_dropdown_overlay_controller/DropdownOverlayHost#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_presentation_dropdown_overlay_controller/DropdownOverlayHost#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_presentation_dropdown_overlay_controller/DropdownOverlayHost#operator-equals).
...
If a subclass overrides [hashCode](/api/src_presentation_dropdown_overlay_controller/DropdownOverlayHost#prop-hashcode), it should override the
[operator ==](/api/src_presentation_dropdown_overlay_controller/DropdownOverlayHost#operator-equals) operator as well to maintain consistency.
...
### menuKeyHandler <span class="docs-badge docs-badge-tip">no setter</span> {#prop-menukeyhandler}
...
### menuPointerSignalHandler <span class="docs-badge docs-badge-tip">no setter</span> {#prop-menupointersignalhandler}
...
### triggerContext <span class="docs-badge docs-badge-tip">no setter</span> {#prop-triggercontext}
...
### triggerFocusNode <span class="docs-badge docs-badge-tip">no setter</span> {#prop-triggerfocusnode}
