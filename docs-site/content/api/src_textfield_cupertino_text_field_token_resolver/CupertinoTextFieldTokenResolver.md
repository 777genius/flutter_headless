---
title: "CupertinoTextFieldTokenResolver"
description: "API documentation for CupertinoTextFieldTokenResolver class from cupertino_text_field_token_resolver"
category: "Classes"
library: "cupertino_text_field_token_resolver"
outline: [2, 3]
---

# CupertinoTextFieldTokenResolver

<div class="member-signature"><div class="member-signature-code"><span class="kw">class</span> <span class="fn">CupertinoTextFieldTokenResolver</span></div></div>

Cupertino token resolver for TextField components.

Implements [RTextFieldTokenResolver](/api/src_renderers_textfield_r_text_field_token_resolver/RTextFieldTokenResolver) with iOS styling.
...
### CupertinoTextFieldTokenResolver() <span class="docs-badge docs-badge-tip">const</span> {#ctor-cupertinotextfieldtokenresolver}

<div class="member-signature"><div class="member-signature-code"><span class="kw">const</span> <span class="fn">CupertinoTextFieldTokenResolver</span>({<span class="type">dynamic</span> <span class="param">brightness</span>})</div></div>
...
that affects [operator ==](/api/src_textfield_cupertino_text_field_token_resolver/CupertinoTextFieldTokenResolver#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_textfield_cupertino_text_field_token_resolver/CupertinoTextFieldTokenResolver#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_textfield_cupertino_text_field_token_resolver/CupertinoTextFieldTokenResolver#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_textfield_cupertino_text_field_token_resolver/CupertinoTextFieldTokenResolver#operator-equals).
...
If a subclass overrides [hashCode](/api/src_textfield_cupertino_text_field_token_resolver/CupertinoTextFieldTokenResolver#prop-hashcode), it should override the
[operator ==](/api/src_textfield_cupertino_text_field_token_resolver/CupertinoTextFieldTokenResolver#operator-equals) operator as well to maintain consistency.
