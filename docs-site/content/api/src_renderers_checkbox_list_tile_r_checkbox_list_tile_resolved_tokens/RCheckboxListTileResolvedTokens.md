---
title: "RCheckboxListTileResolvedTokens"
description: "API documentation for RCheckboxListTileResolvedTokens class from r_checkbox_list_tile_resolved_tokens"
category: "Classes"
library: "r_checkbox_list_tile_resolved_tokens"
outline: [2, 3]
---

# RCheckboxListTileResolvedTokens <span class="docs-badge docs-badge-info">final</span>

<div class="member-signature"><div class="member-signature-code"><span class="kw">final</span> <span class="kw">class</span> <span class="fn">RCheckboxListTileResolvedTokens</span></div></div>

Resolved visual tokens for checkbox list tile rendering.

## Constructors {#section-constructors}

### RCheckboxListTileResolvedTokens() <span class="docs-badge docs-badge-tip">const</span> {#ctor-rcheckboxlisttileresolvedtokens}

<div class="member-signature"><div class="member-signature-code"><span class="member-signature-line"><span class="kw">const</span> <span class="fn">RCheckboxListTileResolvedTokens</span>({</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">dynamic</span> <span class="param">contentPadding</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">double</span> <span class="param">minHeight</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">double</span> <span class="param">horizontalGap</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">double</span> <span class="param">verticalGap</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">dynamic</span> <span class="param">titleStyle</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">dynamic</span> <span class="param">subtitleStyle</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">double</span> <span class="param">disabledOpacity</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">dynamic</span> <span class="param">pressOverlayColor</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">double</span> <span class="param">pressOpacity</span>,</span><span class="member-signature-line">  <a href="/api/src_renderers_checkbox_list_tile_r_checkbox_list_tile_motion_tokens/RCheckboxListTileMotionTokens" class="type-link">RCheckboxListTileMotionTokens</a>? <span class="param">motion</span>,</span><span class="member-signature-line">})</span></div></div>
...
that affects [operator ==](/api/src_renderers_checkbox_list_tile_r_checkbox_list_tile_resolved_tokens/RCheckboxListTileResolvedTokens#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_renderers_checkbox_list_tile_r_checkbox_list_tile_resolved_tokens/RCheckboxListTileResolvedTokens#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_renderers_checkbox_list_tile_r_checkbox_list_tile_resolved_tokens/RCheckboxListTileResolvedTokens#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_renderers_checkbox_list_tile_r_checkbox_list_tile_resolved_tokens/RCheckboxListTileResolvedTokens#operator-equals).
...
If a subclass overrides [hashCode](/api/src_renderers_checkbox_list_tile_r_checkbox_list_tile_resolved_tokens/RCheckboxListTileResolvedTokens#prop-hashcode), it should override the
[operator ==](/api/src_renderers_checkbox_list_tile_r_checkbox_list_tile_resolved_tokens/RCheckboxListTileResolvedTokens#operator-equals) operator as well to maintain consistency.
...
<div class="member-signature"><div class="member-signature-code"><span class="kw">final</span> <a href="/api/src_renderers_checkbox_list_tile_r_checkbox_list_tile_motion_tokens/RCheckboxListTileMotionTokens" class="type-link">RCheckboxListTileMotionTokens</a>? <span class="fn">motion</span></div></div>
...
the [hashCode](/api/src_renderers_checkbox_list_tile_r_checkbox_list_tile_resolved_tokens/RCheckboxListTileResolvedTokens#prop-hashcode) method as well to maintain consistency.
