---
title: "CupertinoSwitchTrackAndThumb"
description: "API documentation for CupertinoSwitchTrackAndThumb class from cupertino_switch_track_and_thumb"
category: "Classes"
library: "cupertino_switch_track_and_thumb"
outline: [2, 3]
---

# CupertinoSwitchTrackAndThumb <span class="docs-badge docs-badge-info">final</span>

<div class="member-signature"><div class="member-signature-code"><span class="kw">final</span> <span class="kw">class</span> <span class="fn">CupertinoSwitchTrackAndThumb</span></div></div>
...
that affects [operator ==](/api/src_switch_cupertino_switch_track_and_thumb/CupertinoSwitchTrackAndThumb#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_switch_cupertino_switch_track_and_thumb/CupertinoSwitchTrackAndThumb#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_switch_cupertino_switch_track_and_thumb/CupertinoSwitchTrackAndThumb#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_switch_cupertino_switch_track_and_thumb/CupertinoSwitchTrackAndThumb#operator-equals).
...
If a subclass overrides [hashCode](/api/src_switch_cupertino_switch_track_and_thumb/CupertinoSwitchTrackAndThumb#prop-hashcode), it should override the
[operator ==](/api/src_switch_cupertino_switch_track_and_thumb/CupertinoSwitchTrackAndThumb#operator-equals) operator as well to maintain consistency.
...
### positionT <span class="docs-badge docs-badge-tip">final</span> {#prop-positiont}

<div class="member-signature"><div class="member-signature-code"><span class="kw">final</span> <span class="type">double</span> <span class="fn">positionT</span></div></div>
...
### reactionDuration <span class="docs-badge docs-badge-tip">final</span> {#prop-reactionduration}

<div class="member-signature"><div class="member-signature-code"><span class="kw">final</span> <span class="type">Duration</span> <span class="fn">reactionDuration</span></div></div>
...
### thumbSlideDuration <span class="docs-badge docs-badge-tip">final</span> {#prop-thumbslideduration}

<div class="member-signature"><div class="member-signature-code"><span class="kw">final</span> <span class="type">Duration</span> <span class="fn">thumbSlideDuration</span></div></div>
