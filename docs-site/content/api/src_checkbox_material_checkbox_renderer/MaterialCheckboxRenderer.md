---
title: "MaterialCheckboxRenderer"
description: "API documentation for MaterialCheckboxRenderer class from material_checkbox_renderer"
category: "Classes"
library: "material_checkbox_renderer"
outline: [2, 3]
---

# MaterialCheckboxRenderer

<div class="member-signature"><div class="member-signature-code"><span class="kw">class</span> <span class="fn">MaterialCheckboxRenderer</span></div></div>

Material 3 renderer for Checkbox components.

Implements [RCheckboxRenderer](/api/src_renderers_checkbox_r_checkbox_renderer/RCheckboxRenderer) with Material Design 3 visuals.
...
### MaterialCheckboxRenderer() <span class="docs-badge docs-badge-tip">const</span> {#ctor-materialcheckboxrenderer}

<div class="member-signature"><div class="member-signature-code"><span class="kw">const</span> <span class="fn">MaterialCheckboxRenderer</span>()</div></div>
...
that affects [operator ==](/api/src_checkbox_material_checkbox_renderer/MaterialCheckboxRenderer#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_checkbox_material_checkbox_renderer/MaterialCheckboxRenderer#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_checkbox_material_checkbox_renderer/MaterialCheckboxRenderer#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_checkbox_material_checkbox_renderer/MaterialCheckboxRenderer#operator-equals).
...
If a subclass overrides [hashCode](/api/src_checkbox_material_checkbox_renderer/MaterialCheckboxRenderer#prop-hashcode), it should override the
[operator ==](/api/src_checkbox_material_checkbox_renderer/MaterialCheckboxRenderer#operator-equals) operator as well to maintain consistency.
