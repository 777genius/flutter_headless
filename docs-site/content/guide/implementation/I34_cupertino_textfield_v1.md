...
- [Part 1 — API и контракты](/guide/implementation/I34_cupertino_textfield_v1_api_contracts)
- [Part 2 — Реализация UI (preset)](/guide/implementation/I34_cupertino_textfield_v1_ui_preset)
- [Part 3 — Тесты и migration](/guide/implementation/I34_cupertino_textfield_v1_tests_migration)
