...
| [SafeDropdownChevronContext](/api/src_renderers_dropdown_safe_dropdown_contexts/SafeDropdownChevronContext) | Context payload for building or decorating dropdown trigger chevron. |
| [SafeDropdownEmptyStateContext](/api/src_renderers_dropdown_safe_dropdown_contexts/SafeDropdownEmptyStateContext) | Context payload for rendering empty-state content in dropdown menus. |
| [SafeDropdownItemContentContext](/api/src_renderers_dropdown_safe_dropdown_contexts/SafeDropdownItemContentContext) | Context payload for custom item content inside dropdown rows. |
| [SafeDropdownItemContext](/api/src_renderers_dropdown_safe_dropdown_contexts/SafeDropdownItemContext) | Context payload for building a full dropdown menu item widget. |
| [SafeDropdownMenuSurfaceContext](/api/src_renderers_dropdown_safe_dropdown_contexts/SafeDropdownMenuSurfaceContext) | Context payload for menu-surface composition (size, style, child). |
...
| [SafeDropdownTriggerContext](/api/src_renderers_dropdown_safe_dropdown_contexts/SafeDropdownTriggerContext) | Context payload for building the dropdown trigger widget and interactions. |
