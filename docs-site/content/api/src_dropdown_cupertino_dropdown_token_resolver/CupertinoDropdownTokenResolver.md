---
title: "CupertinoDropdownTokenResolver"
description: "API documentation for CupertinoDropdownTokenResolver class from cupertino_dropdown_token_resolver"
category: "Classes"
library: "cupertino_dropdown_token_resolver"
outline: [2, 3]
---

# CupertinoDropdownTokenResolver

<div class="member-signature"><div class="member-signature-code"><span class="kw">class</span> <span class="fn">CupertinoDropdownTokenResolver</span></div></div>

Cupertino token resolver for Dropdown components.

Implements [RDropdownTokenResolver](/api/src_renderers_dropdown_r_dropdown_token_resolver/RDropdownTokenResolver) (non-generic) with iOS styling.
...
### CupertinoDropdownTokenResolver() <span class="docs-badge docs-badge-tip">const</span> {#ctor-cupertinodropdowntokenresolver}

<div class="member-signature"><div class="member-signature-code"><span class="kw">const</span> <span class="fn">CupertinoDropdownTokenResolver</span>({<span class="type">dynamic</span> <span class="param">brightness</span>})</div></div>
...
that affects [operator ==](/api/src_dropdown_cupertino_dropdown_token_resolver/CupertinoDropdownTokenResolver#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_dropdown_cupertino_dropdown_token_resolver/CupertinoDropdownTokenResolver#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_dropdown_cupertino_dropdown_token_resolver/CupertinoDropdownTokenResolver#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_dropdown_cupertino_dropdown_token_resolver/CupertinoDropdownTokenResolver#operator-equals).
...
If a subclass overrides [hashCode](/api/src_dropdown_cupertino_dropdown_token_resolver/CupertinoDropdownTokenResolver#prop-hashcode), it should override the
[operator ==](/api/src_dropdown_cupertino_dropdown_token_resolver/CupertinoDropdownTokenResolver#operator-equals) operator as well to maintain consistency.
