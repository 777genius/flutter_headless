---
title: "headless_autocomplete"
description: "API documentation for the headless_autocomplete library"
outline: [2, 3]
---
...
| [RAutocompleteRemoteStateIndicator](/api/src_presentation_r_autocomplete_remote_state_indicator/RAutocompleteRemoteStateIndicator) | Default widget that renders loading, error, or status hints for remote autocomplete states. |
