---
title: "HeadlessCupertinoApp"
description: "API documentation for HeadlessCupertinoApp class from headless_cupertino_app"
category: "Classes"
library: "headless_cupertino_app"
outline: [2, 3]
---

# HeadlessCupertinoApp

<div class="member-signature"><div class="member-signature-code"><span class="kw">class</span> <span class="fn">HeadlessCupertinoApp</span></div></div>

CupertinoApp bootstrap for Headless.

What it does:

- Provides [HeadlessThemeProvider](/api/src_theme_headless_theme_provider/HeadlessThemeProvider) with [CupertinoHeadlessTheme](/api/src_cupertino_headless_theme/CupertinoHeadlessTheme) by default.
...
that affects [operator ==](/api/headless_cupertino_app/HeadlessCupertinoApp#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/headless_cupertino_app/HeadlessCupertinoApp#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/headless_cupertino_app/HeadlessCupertinoApp#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/headless_cupertino_app/HeadlessCupertinoApp#operator-equals).
...
If a subclass overrides [hashCode](/api/headless_cupertino_app/HeadlessCupertinoApp#prop-hashcode), it should override the
[operator ==](/api/headless_cupertino_app/HeadlessCupertinoApp#operator-equals) operator as well to maintain consistency.
...
Defaults to [CupertinoHeadlessTheme](/api/src_cupertino_headless_theme/CupertinoHeadlessTheme).
...
If you provide a custom [headlessTheme](/api/headless_cupertino_app/HeadlessCupertinoApp#prop-headlesstheme) that intentionally omits token resolvers,
