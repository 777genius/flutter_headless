...
Related documents:
- [`docs/MUST.md`](/guide/MUST) - key improvements and principles.
- [`docs/ARCHITECTURE.md`](/guide/ARCHITECTURE) - target architecture: monorepo + DDD + SOLID (полный текст: `docs/ARCHITECTURE.md`, части в `docs/implementation/other/`).
- [`docs/SPEC_V1.md`](/guide/SPEC_V1) - specification for compatible components/packages.
- [`docs/CONFORMANCE.md`](/guide/CONFORMANCE) - how to declare Headless compatibility and the minimum checks required.
...
Headless (see [`docs/ARCHITECTURE.md`](/guide/ARCHITECTURE)) relies on:
