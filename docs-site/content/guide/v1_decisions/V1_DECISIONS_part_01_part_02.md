...
**Contracts (0.1-0.7):**
- [0.1 Renderer contracts](/guide/v1_decisions/V1_DECISIONS_part_01_part_02#01-headless_contracts-renderer-contracts--capability-discovery-минимум)
- [0.2 Overlay](/guide/v1_decisions/V1_DECISIONS_part_01_part_02#02-anchored_overlay_engine-anchoredoverlayenginehostcontrollerhandle-минимум)
- [0.3 Listbox](/guide/v1_decisions/V1_DECISIONS_part_01_part_02#03-headless_foundationlistbox-itemregistry--navigationtypeahead-минимум)
- [0.4 State Resolution](/guide/v1_decisions/V1_DECISIONS_part_01_part_02#04-headless_foundationstate_resolution-нормализация-и-приоритеты-widgetstate-минимум)
- [0.5 Test helpers](/guide/v1_decisions/V1_DECISIONS_part_01_part_02#05-headless_test-a11yoverlayfocuskeyboard-helpers-минимум)
- [0.6 Interactions](/guide/v1_decisions/V1_DECISIONS_part_01_part_02#06-headless_foundationinteractions-interactioncontroller-зафиксировано)
- [0.7 Effects Executor](/guide/v1_decisions/V1_DECISIONS_part_01_part_02#07-effects-executor-contract-зафиксировано)

**Архитектура:**
- [Token Resolution Layer](/guide/v1_decisions/V1_DECISIONS_part_01_part_02#token-resolution-layer--ownership-зафиксировано)
- [Dual API (D2a/D2b)](/guide/v1_decisions/V1_DECISIONS_part_01_part_02#dual-api-d2a-сейчас-путь-к-d2b-потом--зафиксировано)
- [E1 (Events + Reducer + Effects)](/guide/v1_decisions/V1_DECISIONS_part_01_part_02#единый-стандарт-поведения-v1-e1-events--pure-reducer--effects)
- [API Stability Matrix](/guide/v1_decisions/V1_DECISIONS_part_01_part_02#api-stability-matrix-v10-зафиксировано)
- [Sealed vs Open Boundaries](/guide/v1_decisions/V1_DECISIONS_part_01_part_02#sealed-vs-open-boundaries-зафиксировано)

**Policies:**
- [Versioning (SemVer)](/guide/v1_decisions/V1_DECISIONS_part_01_part_02#9-версионирование-lockstep-semver)
- [Error Handling](/guide/v1_decisions/V1_DECISIONS_part_01_part_02#error-handling-policy-зафиксировано)
- [Migration Guides](/guide/v1_decisions/V1_DECISIONS_part_01_part_02#migration-guides-зафиксировано)
