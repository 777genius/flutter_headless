---
title: "anchored_overlay_layout"
description: "API documentation for the anchored_overlay_layout library"
outline: [2, 3]
---

# anchored_overlay_layout

## Classes {#section-classes}

| Class | Description |
|---|---|
| [AnchoredOverlayLayout](/api/src_positioning_anchored_overlay_layout/AnchoredOverlayLayout) | No description available in source docs. |
