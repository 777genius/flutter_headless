---
title: "RCheckbox"
description: "API documentation for RCheckbox class from r_checkbox"
category: "Classes"
library: "r_checkbox"
outline: [2, 3]
---
...
<div class="member-signature"><div class="member-signature-code"><span class="kw">class</span> <span class="fn">RCheckbox</span></div></div>
...
- Visuals are delegated to [RCheckboxRenderer](/api/src_renderers_checkbox_r_checkbox_renderer/RCheckboxRenderer) capability.

API is intentionally close to Flutter's Checkbox/CupertinoCheckbox:
[value](/api/src_presentation_r_checkbox/RCheckbox#prop-value), [tristate](/api/src_presentation_r_checkbox/RCheckbox#prop-tristate), [onChanged](/api/src_presentation_r_checkbox/RCheckbox#prop-onchanged), [focusNode](/api/src_presentation_r_checkbox/RCheckbox#prop-focusnode), [autofocus](/api/src_presentation_r_checkbox/RCheckbox#prop-autofocus), [mouseCursor](/api/src_presentation_r_checkbox/RCheckbox#prop-mousecursor),
[semanticLabel](/api/src_presentation_r_checkbox/RCheckbox#prop-semanticlabel), [isError](/api/src_presentation_r_checkbox/RCheckbox#prop-iserror).

## Constructors {#section-constructors}

### RCheckbox() <span class="docs-badge docs-badge-tip">const</span> {#ctor-rcheckbox}

<div class="member-signature"><div class="member-signature-code"><span class="member-signature-line"><span class="kw">const</span> <span class="fn">RCheckbox</span>({</span><span class="member-signature-line">  <span class="type">dynamic</span> <span class="param">key</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">bool</span>? <span class="param">value</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">dynamic</span> <span class="param">onChanged</span>,</span><span class="member-signature-line">  <span class="type">bool</span> <span class="param">tristate</span> = <span class="kw">false</span>,</span><span class="member-signature-line">  <span class="type">dynamic</span> <span class="param">focusNode</span>,</span><span class="member-signature-line">  <span class="type">bool</span> <span class="param">autofocus</span> = <span class="kw">false</span>,</span><span class="member-signature-line">  <span class="type">dynamic</span> <span class="param">mouseCursor</span>,</span><span class="member-signature-line">  <span class="type">String</span>? <span class="param">semanticLabel</span>,</span><span class="member-signature-line">  <span class="type">bool</span> <span class="param">isError</span> = <span class="kw">false</span>,</span><span class="member-signature-line">  <a href="/api/src_presentation_r_checkbox_style/RCheckboxStyle" class="type-link">RCheckboxStyle</a>? <span class="param">style</span>,</span><span class="member-signature-line">  <span class="type">dynamic</span> <span class="param">slots</span>,</span><span class="member-signature-line">  <span class="type">dynamic</span> <span class="param">overrides</span>,</span><span class="member-signature-line">})</span></div></div>
...
that affects [operator ==](/api/src_presentation_r_checkbox/RCheckbox#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_presentation_r_checkbox/RCheckbox#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_presentation_r_checkbox/RCheckbox#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_presentation_r_checkbox/RCheckbox#operator-equals).
...
If a subclass overrides [hashCode](/api/src_presentation_r_checkbox/RCheckbox#prop-hashcode), it should override the
[operator ==](/api/src_presentation_r_checkbox/RCheckbox#operator-equals) operator as well to maintain consistency.
...
<div class="member-signature"><div class="member-signature-code"><span class="kw">final</span> <a href="/api/src_presentation_r_checkbox_style/RCheckboxStyle" class="type-link">RCheckboxStyle</a>? <span class="fn">style</span></div></div>

Simple, Flutter-like styling sugar.

Internally converted to `RenderOverrides.only(RCheckboxOverrides.tokens(...))`.
If [overrides](/api/src_presentation_r_checkbox/RCheckbox#prop-overrides) is provided, it takes precedence over this style.
...
If [tristate](/api/src_presentation_r_checkbox/RCheckbox#prop-tristate) is true, this can also be null (indeterminate).
