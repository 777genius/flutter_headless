---
title: "MaterialCheckboxListTileRenderer"
description: "API documentation for MaterialCheckboxListTileRenderer class from material_checkbox_list_tile_renderer"
category: "Classes"
library: "material_checkbox_list_tile_renderer"
outline: [2, 3]
---

# MaterialCheckboxListTileRenderer

<div class="member-signature"><div class="member-signature-code"><span class="kw">class</span> <span class="fn">MaterialCheckboxListTileRenderer</span></div></div>

Material 3 renderer for CheckboxListTile components.

## Constructors {#section-constructors}

### MaterialCheckboxListTileRenderer() <span class="docs-badge docs-badge-tip">const</span> {#ctor-materialcheckboxlisttilerenderer}

<div class="member-signature"><div class="member-signature-code"><span class="kw">const</span> <span class="fn">MaterialCheckboxListTileRenderer</span>({<a href="/api/src_overrides_material_list_tile_overrides/MaterialListTileOverrides" class="type-link">MaterialListTileOverrides</a>? <span class="param">defaults</span>})</div></div>
...
<div class="member-signature"><div class="member-signature-code"><span class="kw">final</span> <a href="/api/src_overrides_material_list_tile_overrides/MaterialListTileOverrides" class="type-link">MaterialListTileOverrides</a>? <span class="fn">defaults</span></div></div>
...
that affects [operator ==](/api/src_checkbox_list_tile_material_checkbox_list_tile_renderer/MaterialCheckboxListTileRenderer#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_checkbox_list_tile_material_checkbox_list_tile_renderer/MaterialCheckboxListTileRenderer#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_checkbox_list_tile_material_checkbox_list_tile_renderer/MaterialCheckboxListTileRenderer#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_checkbox_list_tile_material_checkbox_list_tile_renderer/MaterialCheckboxListTileRenderer#operator-equals).
...
If a subclass overrides [hashCode](/api/src_checkbox_list_tile_material_checkbox_list_tile_renderer/MaterialCheckboxListTileRenderer#prop-hashcode), it should override the
[operator ==](/api/src_checkbox_list_tile_material_checkbox_list_tile_renderer/MaterialCheckboxListTileRenderer#operator-equals) operator as well to maintain consistency.
