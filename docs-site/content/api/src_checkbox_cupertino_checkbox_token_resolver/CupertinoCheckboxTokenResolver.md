---
title: "CupertinoCheckboxTokenResolver"
description: "API documentation for CupertinoCheckboxTokenResolver class from cupertino_checkbox_token_resolver"
category: "Classes"
library: "cupertino_checkbox_token_resolver"
outline: [2, 3]
---

# CupertinoCheckboxTokenResolver

<div class="member-signature"><div class="member-signature-code"><span class="kw">class</span> <span class="fn">CupertinoCheckboxTokenResolver</span></div></div>

Cupertino token resolver for Checkbox components.

Implements [RCheckboxTokenResolver](/api/src_renderers_checkbox_r_checkbox_token_resolver/RCheckboxTokenResolver) with Cupertino styling.
...
### CupertinoCheckboxTokenResolver() <span class="docs-badge docs-badge-tip">const</span> {#ctor-cupertinocheckboxtokenresolver}

<div class="member-signature"><div class="member-signature-code"><span class="kw">const</span> <span class="fn">CupertinoCheckboxTokenResolver</span>({<span class="type">dynamic</span> <span class="param">brightness</span>})</div></div>
...
that affects [operator ==](/api/src_checkbox_cupertino_checkbox_token_resolver/CupertinoCheckboxTokenResolver#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_checkbox_cupertino_checkbox_token_resolver/CupertinoCheckboxTokenResolver#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_checkbox_cupertino_checkbox_token_resolver/CupertinoCheckboxTokenResolver#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_checkbox_cupertino_checkbox_token_resolver/CupertinoCheckboxTokenResolver#operator-equals).
...
If a subclass overrides [hashCode](/api/src_checkbox_cupertino_checkbox_token_resolver/CupertinoCheckboxTokenResolver#prop-hashcode), it should override the
[operator ==](/api/src_checkbox_cupertino_checkbox_token_resolver/CupertinoCheckboxTokenResolver#operator-equals) operator as well to maintain consistency.
