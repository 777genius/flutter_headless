---
title: "headless_workspace"
description: "API documentation for the headless_workspace package"
outline: false
---
...
## 60s quick start (Material) {#60s-quick-start-material}
...
## Customization in 30s (safe path) {#customization-in-30s-safe-path}

These examples customize visuals without reimplementing a renderer.

### Button (decorate surface) {#button-decorate-surface}
...
## Quick start (Cupertino) {#quick-start-cupertino}
...
## When Headless is overkill {#when-headless-is-overkill}
