...
that affects [operator ==](/api/src_presentation_r_dropdown_trigger_shell/RDropdownTriggerShell#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_presentation_r_dropdown_trigger_shell/RDropdownTriggerShell#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_presentation_r_dropdown_trigger_shell/RDropdownTriggerShell#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_presentation_r_dropdown_trigger_shell/RDropdownTriggerShell#operator-equals).
...
If a subclass overrides [hashCode](/api/src_presentation_r_dropdown_trigger_shell/RDropdownTriggerShell#prop-hashcode), it should override the
[operator ==](/api/src_presentation_r_dropdown_trigger_shell/RDropdownTriggerShell#operator-equals) operator as well to maintain consistency.
...
### isExpanded <span class="docs-badge docs-badge-tip">final</span> {#prop-isexpanded}

<div class="member-signature"><div class="member-signature-code"><span class="kw">final</span> <span class="type">bool</span> <span class="fn">isExpanded</span></div></div>
...
### onEscape <span class="docs-badge docs-badge-tip">final</span> {#prop-onescape}

<div class="member-signature"><div class="member-signature-code"><span class="kw">final</span> <span class="type">dynamic</span> <span class="fn">onEscape</span></div></div>
...
### onFocusLost <span class="docs-badge docs-badge-tip">final</span> {#prop-onfocuslost}

<div class="member-signature"><div class="member-signature-code"><span class="kw">final</span> <span class="type">dynamic</span> <span class="fn">onFocusLost</span></div></div>
...
### onToggleMenu <span class="docs-badge docs-badge-tip">final</span> {#prop-ontogglemenu}

<div class="member-signature"><div class="member-signature-code"><span class="kw">final</span> <span class="type">dynamic</span> <span class="fn">onToggleMenu</span></div></div>
...
### triggerKey <span class="docs-badge docs-badge-tip">final</span> {#prop-triggerkey}

<div class="member-signature"><div class="member-signature-code"><span class="kw">final</span> <span class="type">dynamic</span> <span class="fn">triggerKey</span></div></div>
