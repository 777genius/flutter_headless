---
title: "RCheckboxIndicator"
description: "API documentation for RCheckboxIndicator class from r_checkbox_indicator"
category: "Classes"
library: "r_checkbox_indicator"
outline: [2, 3]
---

# RCheckboxIndicator

<div class="member-signature"><div class="member-signature-code"><span class="kw">class</span> <span class="fn">RCheckboxIndicator</span></div></div>

Non-interactive checkbox visual used by composite components.

## Constructors {#section-constructors}

### RCheckboxIndicator() <span class="docs-badge docs-badge-tip">const</span> {#ctor-rcheckboxindicator}

<div class="member-signature"><div class="member-signature-code"><span class="member-signature-line"><span class="kw">const</span> <span class="fn">RCheckboxIndicator</span>({</span><span class="member-signature-line">  <span class="type">dynamic</span> <span class="param">key</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">dynamic</span> <span class="param">spec</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">dynamic</span> <span class="param">state</span>,</span><span class="member-signature-line">  <span class="type">dynamic</span> <span class="param">slots</span>,</span><span class="member-signature-line">  <span class="type">dynamic</span> <span class="param">overrides</span>,</span><span class="member-signature-line">})</span></div></div>
...
that affects [operator ==](/api/src_presentation_r_checkbox_indicator/RCheckboxIndicator#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_presentation_r_checkbox_indicator/RCheckboxIndicator#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_presentation_r_checkbox_indicator/RCheckboxIndicator#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_presentation_r_checkbox_indicator/RCheckboxIndicator#operator-equals).
...
If a subclass overrides [hashCode](/api/src_presentation_r_checkbox_indicator/RCheckboxIndicator#prop-hashcode), it should override the
[operator ==](/api/src_presentation_r_checkbox_indicator/RCheckboxIndicator#operator-equals) operator as well to maintain consistency.
