---
title: "AutocompleteMenuHostDelegate"
description: "API documentation for AutocompleteMenuHostDelegate class from autocomplete_menu_host_delegate"
category: "Classes"
library: "autocomplete_menu_host_delegate"
outline: [2, 3]
---

# AutocompleteMenuHostDelegate <span class="docs-badge docs-badge-info">final</span>

<div class="member-signature"><div class="member-signature-code"><span class="kw">final</span> <span class="kw">class</span> <span class="fn">AutocompleteMenuHostDelegate</span> <span class="kw">implements</span> <a href="/api/src_presentation_autocomplete_menu_overlay_controller/AutocompleteMenuOverlayHost" class="type-link">AutocompleteMenuOverlayHost</a></div></div>

:::info Implemented types
- [AutocompleteMenuOverlayHost](/api/src_presentation_autocomplete_menu_overlay_controller/AutocompleteMenuOverlayHost)
:::

## Constructors {#section-constructors}

### AutocompleteMenuHostDelegate() {#ctor-autocompletemenuhostdelegate}

<div class="member-signature"><div class="member-signature-code"><span class="member-signature-line"><span class="fn">AutocompleteMenuHostDelegate</span>({</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">dynamic</span> <span class="type">Function</span>() <span class="param">contextGetter</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">bool</span> <span class="type">Function</span>() <span class="param">isDisposedGetter</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">dynamic</span> <span class="type">Function</span>() <span class="param">anchorRectGetter</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">dynamic</span> <span class="type">Function</span>() <span class="param">anchorFocusNodeGetter</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">int</span>? <span class="type">Function</span>() <span class="param">highlightedIndexGetter</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">dynamic</span> <span class="type">Function</span>(<span class="type">dynamic</span>) <span class="param">menuRequestBuilder</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">dynamic</span> <span class="param">notifyStateChanged</span>,</span><span class="member-signature-line">});</span></div></div>
...
### anchorFocusNode <span class="docs-badge docs-badge-tip">no setter</span> <span class="docs-badge docs-badge-info">override</span> {#prop-anchorfocusnode}

<div class="member-signature"><div class="member-signature-code"><span class="type">dynamic</span> <span class="kw">get</span> <span class="fn">anchorFocusNode</span></div></div>
...
that affects [operator ==](/api/src_presentation_autocomplete_menu_host_delegate/AutocompleteMenuHostDelegate#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_presentation_autocomplete_menu_host_delegate/AutocompleteMenuHostDelegate#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_presentation_autocomplete_menu_host_delegate/AutocompleteMenuHostDelegate#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_presentation_autocomplete_menu_host_delegate/AutocompleteMenuHostDelegate#operator-equals).
...
If a subclass overrides [hashCode](/api/src_presentation_autocomplete_menu_host_delegate/AutocompleteMenuHostDelegate#prop-hashcode), it should override the
[operator ==](/api/src_presentation_autocomplete_menu_host_delegate/AutocompleteMenuHostDelegate#operator-equals) operator as well to maintain consistency.
