...
- [I23 (часть 2) — Foundation: инварианты + `HeadlessContent`/features/model](/guide/implementation/I23_rich_list_item_model_vnext_part_2_foundation_model)
- [I23 (часть 3) — Foundation: `HeadlessItemAdapter<T>`, typeahead, `ListboxController.setMetas`](/guide/implementation/I23_rich_list_item_model_vnext_part_3_foundation_adapter)
- [I23 (часть 4) — Интеграция: `headless_theme`/`headless_dropdown_button`/presets/tests/guardrails](/guide/implementation/I23_rich_list_item_model_vnext_part_4_integration_and_tests)
- [I23 (часть 5) — Пример Country select + порядок реализации + DoD](/guide/implementation/I23_rich_list_item_model_vnext_part_5_example_and_plan)
