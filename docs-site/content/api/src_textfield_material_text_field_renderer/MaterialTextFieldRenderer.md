---
title: "MaterialTextFieldRenderer"
description: "API documentation for MaterialTextFieldRenderer class from material_text_field_renderer"
category: "Classes"
library: "material_text_field_renderer"
outline: [2, 3]
---

# MaterialTextFieldRenderer

<div class="member-signature"><div class="member-signature-code"><span class="kw">class</span> <span class="fn">MaterialTextFieldRenderer</span></div></div>
...
Material 3 only — throws [StateError](https://api.flutter.dev/flutter/dart-core/StateError-class.html) when `useMaterial3 == false`.
...
### MaterialTextFieldRenderer() <span class="docs-badge docs-badge-tip">const</span> {#ctor-materialtextfieldrenderer}

<div class="member-signature"><div class="member-signature-code"><span class="kw">const</span> <span class="fn">MaterialTextFieldRenderer</span>()</div></div>
...
that affects [operator ==](/api/src_textfield_material_text_field_renderer/MaterialTextFieldRenderer#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_textfield_material_text_field_renderer/MaterialTextFieldRenderer#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_textfield_material_text_field_renderer/MaterialTextFieldRenderer#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_textfield_material_text_field_renderer/MaterialTextFieldRenderer#operator-equals).
...
If a subclass overrides [hashCode](/api/src_textfield_material_text_field_renderer/MaterialTextFieldRenderer#prop-hashcode), it should override the
[operator ==](/api/src_textfield_material_text_field_renderer/MaterialTextFieldRenderer#operator-equals) operator as well to maintain consistency.
