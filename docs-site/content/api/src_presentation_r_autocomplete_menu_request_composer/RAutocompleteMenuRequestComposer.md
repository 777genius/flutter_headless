---
title: "RAutocompleteMenuRequestComposer"
description: "API documentation for RAutocompleteMenuRequestComposer class from r_autocomplete_menu_request_composer"
category: "Classes"
library: "r_autocomplete_menu_request_composer"
outline: [2, 3]
---

# RAutocompleteMenuRequestComposer <span class="docs-badge docs-badge-info">final</span>

<div class="member-signature"><div class="member-signature-code"><span class="kw">final</span> <span class="kw">class</span> <span class="fn">RAutocompleteMenuRequestComposer</span></div></div>

## Constructors {#section-constructors}

### RAutocompleteMenuRequestComposer() <span class="docs-badge docs-badge-tip">const</span> {#ctor-rautocompletemenurequestcomposer}

<div class="member-signature"><div class="member-signature-code"><span class="kw">const</span> <span class="fn">RAutocompleteMenuRequestComposer</span>()</div></div>
...
that affects [operator ==](/api/src_presentation_r_autocomplete_menu_request_composer/RAutocompleteMenuRequestComposer#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_presentation_r_autocomplete_menu_request_composer/RAutocompleteMenuRequestComposer#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_presentation_r_autocomplete_menu_request_composer/RAutocompleteMenuRequestComposer#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_presentation_r_autocomplete_menu_request_composer/RAutocompleteMenuRequestComposer#operator-equals).
...
If a subclass overrides [hashCode](/api/src_presentation_r_autocomplete_menu_request_composer/RAutocompleteMenuRequestComposer#prop-hashcode), it should override the
[operator ==](/api/src_presentation_r_autocomplete_menu_request_composer/RAutocompleteMenuRequestComposer#operator-equals) operator as well to maintain consistency.
