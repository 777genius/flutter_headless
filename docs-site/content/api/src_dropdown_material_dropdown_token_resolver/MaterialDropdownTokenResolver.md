---
title: "MaterialDropdownTokenResolver"
description: "API documentation for MaterialDropdownTokenResolver class from material_dropdown_token_resolver"
category: "Classes"
library: "material_dropdown_token_resolver"
outline: [2, 3]
---

# MaterialDropdownTokenResolver

<div class="member-signature"><div class="member-signature-code"><span class="kw">class</span> <span class="fn">MaterialDropdownTokenResolver</span></div></div>

Material 3 token resolver for Dropdown components.

Implements [RDropdownTokenResolver](/api/src_renderers_dropdown_r_dropdown_token_resolver/RDropdownTokenResolver) with Material Design 3 styling.
...
### MaterialDropdownTokenResolver() <span class="docs-badge docs-badge-tip">const</span> {#ctor-materialdropdowntokenresolver}

<div class="member-signature"><div class="member-signature-code"><span class="member-signature-line"><span class="kw">const</span> <span class="fn">MaterialDropdownTokenResolver</span>({</span><span class="member-signature-line">  <span class="type">dynamic</span> <span class="param">colorScheme</span>,</span><span class="member-signature-line">  <span class="type">dynamic</span> <span class="param">textTheme</span>,</span><span class="member-signature-line">  <a href="/api/src_overrides_material_dropdown_overrides/MaterialDropdownOverrides" class="type-link">MaterialDropdownOverrides</a>? <span class="param">defaults</span>,</span><span class="member-signature-line">})</span></div></div>
...
### defaults <span class="docs-badge docs-badge-tip">final</span> {#prop-defaults}

<div class="member-signature"><div class="member-signature-code"><span class="kw">final</span> <a href="/api/src_overrides_material_dropdown_overrides/MaterialDropdownOverrides" class="type-link">MaterialDropdownOverrides</a>? <span class="fn">defaults</span></div></div>
...
that affects [operator ==](/api/src_dropdown_material_dropdown_token_resolver/MaterialDropdownTokenResolver#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_dropdown_material_dropdown_token_resolver/MaterialDropdownTokenResolver#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_dropdown_material_dropdown_token_resolver/MaterialDropdownTokenResolver#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_dropdown_material_dropdown_token_resolver/MaterialDropdownTokenResolver#operator-equals).
...
If a subclass overrides [hashCode](/api/src_dropdown_material_dropdown_token_resolver/MaterialDropdownTokenResolver#prop-hashcode), it should override the
[operator ==](/api/src_dropdown_material_dropdown_token_resolver/MaterialDropdownTokenResolver#operator-equals) operator as well to maintain consistency.
