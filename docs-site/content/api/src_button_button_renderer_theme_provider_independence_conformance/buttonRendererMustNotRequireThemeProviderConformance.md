---
title: "buttonRendererMustNotRequireThemeProviderConformance function"
description: "API documentation for the buttonRendererMustNotRequireThemeProviderConformance function from button_renderer_theme_provider_independence_conformance"
category: "Functions"
library: "button_renderer_theme_provider_independence_conformance"
outline: false
---

# buttonRendererMustNotRequireThemeProviderConformance

<div class="member-signature"><div class="member-signature-code"><span class="member-signature-line"><span class="type">void</span> <span class="fn">buttonRendererMustNotRequireThemeProviderConformance</span>({</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">String</span> <span class="param">presetName</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">dynamic</span> <span class="type">Function</span>() <span class="param">rendererGetter</span>,</span><span class="member-signature-line">  <span class="kw">required</span> <span class="type">dynamic</span> <span class="type">Function</span>(<span class="type">dynamic</span> <span class="param">child</span>) <span class="param">wrapApp</span>,</span><span class="member-signature-line">});</span></div></div>
