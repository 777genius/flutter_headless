---
title: "MaterialSwitchListTileTokenResolver"
description: "API documentation for MaterialSwitchListTileTokenResolver class from material_switch_list_tile_token_resolver"
category: "Classes"
library: "material_switch_list_tile_token_resolver"
outline: [2, 3]
---

# MaterialSwitchListTileTokenResolver

<div class="member-signature"><div class="member-signature-code"><span class="kw">class</span> <span class="fn">MaterialSwitchListTileTokenResolver</span></div></div>

Material 3 token resolver for SwitchListTile components.

## Constructors {#section-constructors}

### MaterialSwitchListTileTokenResolver() <span class="docs-badge docs-badge-tip">const</span> {#ctor-materialswitchlisttiletokenresolver}

<div class="member-signature"><div class="member-signature-code"><span class="member-signature-line"><span class="kw">const</span> <span class="fn">MaterialSwitchListTileTokenResolver</span>({</span><span class="member-signature-line">  <span class="type">dynamic</span> <span class="param">colorScheme</span>,</span><span class="member-signature-line">  <span class="type">dynamic</span> <span class="param">textTheme</span>,</span><span class="member-signature-line">})</span></div></div>

:::details Implementation
```dart
const MaterialSwitchListTileTokenResolver({
  this.colorScheme,
  this.textTheme,
});
```
...
that affects [operator ==](/api/src_switch_list_tile_material_switch_list_tile_token_resolver/MaterialSwitchListTileTokenResolver#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_switch_list_tile_material_switch_list_tile_token_resolver/MaterialSwitchListTileTokenResolver#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_switch_list_tile_material_switch_list_tile_token_resolver/MaterialSwitchListTileTokenResolver#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_switch_list_tile_material_switch_list_tile_token_resolver/MaterialSwitchListTileTokenResolver#operator-equals).
...
If a subclass overrides [hashCode](/api/src_switch_list_tile_material_switch_list_tile_token_resolver/MaterialSwitchListTileTokenResolver#prop-hashcode), it should override the
[operator ==](/api/src_switch_list_tile_material_switch_list_tile_token_resolver/MaterialSwitchListTileTokenResolver#operator-equals) operator as well to maintain consistency.
