...
| [`README.md`](../README.md) | Roadmap | P0-P3 priorities, baseline tasks |

### Table of Contents (Quick Links)

**Structure:**
- [Folder tree](#target-folder-tree)
- [Dependency rules (DDD + SOLID)](#dependency-rules-ddd--solid)
- [Dual API policy](#dual-api-policy-d2a-now-path-to-d2b-later)

**DDD/Clean Architecture:**
- [Domain Layer Invariants](#where-state-must-not-live-ddd-discipline)
- [Bounded Contexts](#bounded-contexts-ddd)
- [Ubiquitous Language](#ubiquitous-language-glossary-of-terms)
- [CI Pipeline Integration](#ci-pipeline-integration-github-actions)

**Quality:**
- [Renderer contracts](#renderer-contracts-capability-discovery--api-stability-policy-v1)
- [LLM.txt policy](#llmtxt-policy-for-each-component-package)
- [Interaction layers + Owners (locked in)](#interaction-layers--owners-locked-in-how-to-do-it-right)
- [Performance](#performance-important-for-headless)
