---
title: "RSwitchListTile"
description: "API documentation for RSwitchListTile class from r_switch_list_tile"
category: "Classes"
library: "r_switch_list_tile"
outline: [2, 3]
---

# RSwitchListTile

<div class="member-signature"><div class="member-signature-code"><span class="kw">class</span> <span class="fn">RSwitchListTile</span></div></div>
...
that affects [operator ==](/api/src_presentation_r_switch_list_tile/RSwitchListTile#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_presentation_r_switch_list_tile/RSwitchListTile#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_presentation_r_switch_list_tile/RSwitchListTile#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_presentation_r_switch_list_tile/RSwitchListTile#operator-equals).
...
If a subclass overrides [hashCode](/api/src_presentation_r_switch_list_tile/RSwitchListTile#prop-hashcode), it should override the
[operator ==](/api/src_presentation_r_switch_list_tile/RSwitchListTile#operator-equals) operator as well to maintain consistency.
...
<div class="member-signature"><div class="member-signature-code"><span class="kw">final</span> <a href="/api/src_presentation_r_switch_list_tile_style/RSwitchListTileStyle" class="type-link">RSwitchListTileStyle</a>? <span class="fn">style</span></div></div>

Simple, Flutter-like styling sugar.

Internally converted to
`RenderOverrides.only(RSwitchListTileOverrides.tokens(...))`.
If [overrides](/api/src_presentation_r_switch_list_tile/RSwitchListTile#prop-overrides) is provided, it takes precedence over this style.
