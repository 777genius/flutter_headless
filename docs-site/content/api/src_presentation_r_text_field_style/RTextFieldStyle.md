---
title: "RTextFieldStyle"
description: "API documentation for RTextFieldStyle class from r_text_field_style"
category: "Classes"
library: "r_text_field_style"
outline: [2, 3]
---

# RTextFieldStyle <span class="docs-badge docs-badge-info">final</span>

<div class="member-signature"><div class="member-signature-code"><span class="kw">final</span> <span class="kw">class</span> <span class="fn">RTextFieldStyle</span></div></div>

Simple, Flutter-like styling sugar for [RTextField](/api/src_presentation_r_text_field/RTextField).
...
that affects [operator ==](/api/src_presentation_r_text_field_style/RTextFieldStyle#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_presentation_r_text_field_style/RTextFieldStyle#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_presentation_r_text_field_style/RTextFieldStyle#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_presentation_r_text_field_style/RTextFieldStyle#operator-equals).
...
If a subclass overrides [hashCode](/api/src_presentation_r_text_field_style/RTextFieldStyle#prop-hashcode), it should override the
[operator ==](/api/src_presentation_r_text_field_style/RTextFieldStyle#operator-equals) operator as well to maintain consistency.
