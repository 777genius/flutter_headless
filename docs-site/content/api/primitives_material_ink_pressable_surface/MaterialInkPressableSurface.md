---
title: "MaterialInkPressableSurface"
description: "API documentation for MaterialInkPressableSurface class from material_ink_pressable_surface"
category: "Classes"
library: "material_ink_pressable_surface"
outline: [2, 3]
---

# MaterialInkPressableSurface

<div class="member-signature"><div class="member-signature-code"><span class="kw">class</span> <span class="fn">MaterialInkPressableSurface</span></div></div>

Material implementation of [HeadlessPressableSurfaceFactory](/api/src_interaction_headless_pressable_surface_factory/HeadlessPressableSurfaceFactory).
...
### MaterialInkPressableSurface() <span class="docs-badge docs-badge-tip">const</span> {#ctor-materialinkpressablesurface}

<div class="member-signature"><div class="member-signature-code"><span class="kw">const</span> <span class="fn">MaterialInkPressableSurface</span>()</div></div>
...
that affects [operator ==](/api/primitives_material_ink_pressable_surface/MaterialInkPressableSurface#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/primitives_material_ink_pressable_surface/MaterialInkPressableSurface#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/primitives_material_ink_pressable_surface/MaterialInkPressableSurface#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/primitives_material_ink_pressable_surface/MaterialInkPressableSurface#operator-equals).
...
If a subclass overrides [hashCode](/api/primitives_material_ink_pressable_surface/MaterialInkPressableSurface#prop-hashcode), it should override the
[operator ==](/api/primitives_material_ink_pressable_surface/MaterialInkPressableSurface#operator-equals) operator as well to maintain consistency.
