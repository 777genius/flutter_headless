---
title: "CupertinoCheckboxListTileTokenResolver"
description: "API documentation for CupertinoCheckboxListTileTokenResolver class from cupertino_checkbox_list_tile_token_resolver"
category: "Classes"
library: "cupertino_checkbox_list_tile_token_resolver"
outline: [2, 3]
---

# CupertinoCheckboxListTileTokenResolver

<div class="member-signature"><div class="member-signature-code"><span class="kw">class</span> <span class="fn">CupertinoCheckboxListTileTokenResolver</span></div></div>

Cupertino token resolver for CheckboxListTile components.

## Constructors {#section-constructors}

### CupertinoCheckboxListTileTokenResolver() <span class="docs-badge docs-badge-tip">const</span> {#ctor-cupertinocheckboxlisttiletokenresolver}

<div class="member-signature"><div class="member-signature-code"><span class="kw">const</span> <span class="fn">CupertinoCheckboxListTileTokenResolver</span>({<span class="type">dynamic</span> <span class="param">brightness</span>})</div></div>
...
that affects [operator ==](/api/src_checkbox_list_tile_cupertino_checkbox_list_tile_token_resolver/CupertinoCheckboxListTileTokenResolver#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_checkbox_list_tile_cupertino_checkbox_list_tile_token_resolver/CupertinoCheckboxListTileTokenResolver#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_checkbox_list_tile_cupertino_checkbox_list_tile_token_resolver/CupertinoCheckboxListTileTokenResolver#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_checkbox_list_tile_cupertino_checkbox_list_tile_token_resolver/CupertinoCheckboxListTileTokenResolver#operator-equals).
...
If a subclass overrides [hashCode](/api/src_checkbox_list_tile_cupertino_checkbox_list_tile_token_resolver/CupertinoCheckboxListTileTokenResolver#prop-hashcode), it should override the
[operator ==](/api/src_checkbox_list_tile_cupertino_checkbox_list_tile_token_resolver/CupertinoCheckboxListTileTokenResolver#operator-equals) operator as well to maintain consistency.
