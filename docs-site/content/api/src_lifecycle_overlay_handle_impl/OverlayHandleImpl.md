---
title: "OverlayHandleImpl"
description: "API documentation for OverlayHandleImpl class from overlay_handle_impl"
category: "Classes"
library: "overlay_handle_impl"
outline: [2, 3]
---

# OverlayHandleImpl

<div class="member-signature"><div class="member-signature-code"><span class="kw">class</span> <span class="fn">OverlayHandleImpl</span> <span class="kw">implements</span> <a href="/api/src_lifecycle_overlay_handle/OverlayHandle" class="type-link">OverlayHandle</a></div></div>

Concrete implementation of [OverlayHandle](/api/src_lifecycle_overlay_handle/OverlayHandle).
...
- [close](/api/src_lifecycle_overlay_handle_impl/OverlayHandleImpl#close) is idempotent (repeated calls are no-op after first)
- [completeClose](/api/src_lifecycle_overlay_handle_impl/OverlayHandleImpl#completeclose) is idempotent
- Phase transitions are monotonic (no rollback)
- Subtree is not removed until `closed` phase

:::info Implemented types
- [OverlayHandle](/api/src_lifecycle_overlay_handle/OverlayHandle)
:::

## Constructors {#section-constructors}

### OverlayHandleImpl() {#ctor-overlayhandleimpl}

<div class="member-signature"><div class="member-signature-code"><span class="member-signature-line"><span class="fn">OverlayHandleImpl</span>({</span><span class="member-signature-line">  <span class="type">Duration</span> <span class="param">failSafeTimeout</span> = kOverlayFailSafeTimeout,</span><span class="member-signature-line">  <span class="type">void</span> <span class="type">Function</span>(<a href="/api/src_lifecycle_overlay_handle/OverlayHandle" class="type-link">OverlayHandle</a> <span class="param">handle</span>)? <span class="param">onFailSafeTimeout</span>,</span><span class="member-signature-line">});</span></div></div>
...
that affects [operator ==](/api/src_lifecycle_overlay_handle_impl/OverlayHandleImpl#operator-equals) comparisons.

All objects have hash codes.
The default hash code implemented by [Object](https://api.flutter.dev/flutter/dart-core/Object-class.html)
represents only the identity of the object,
the same way as the default [operator ==](/api/src_lifecycle_overlay_handle_impl/OverlayHandleImpl#operator-equals) implementation only considers objects
equal if they are identical (see [identityHashCode](https://api.flutter.dev/flutter/dart-core/identityHashCode.html)).

If [operator ==](/api/src_lifecycle_overlay_handle_impl/OverlayHandleImpl#operator-equals) is overridden to use the object state instead,
the hash code must also be changed to represent that state,
otherwise the object cannot be used in hash based data structures
like the default [Set](https://api.flutter.dev/flutter/dart-core/Set-class.html) and [Map](https://api.flutter.dev/flutter/dart-core/Map-class.html) implementations.

Hash codes must be the same for objects that are equal to each other
according to [operator ==](/api/src_lifecycle_overlay_handle_impl/OverlayHandleImpl#operator-equals).
...
If a subclass overrides [hashCode](/api/src_lifecycle_overlay_handle_impl/OverlayHandleImpl#prop-hashcode), it should override the
[operator ==](/api/src_lifecycle_overlay_handle_impl/OverlayHandleImpl#operator-equals) operator as well to maintain consistency.
...
### isOpen <span class="docs-badge docs-badge-tip">no setter</span> <span class="docs-badge docs-badge-info">override</span> {#prop-isopen}
...
### phase <span class="docs-badge docs-badge-tip">no setter</span> <span class="docs-badge docs-badge-info">override</span> {#prop-phase}
...
### close() <span class="docs-badge docs-badge-info">override</span> {#close}
...
### completeClose() <span class="docs-badge docs-badge-info">override</span> {#completeclose}
...
<div class="member-signature"><div class="member-signature-code"><span class="type">void</span> <span class="fn">markOpen</span>()</div></div>
